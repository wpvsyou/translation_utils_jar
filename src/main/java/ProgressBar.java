...
public class ProgressBar {
    ...
    public void showBarByPoint(double currentPoint) {
        ...
        // 生成进度条
        System.out.print("\r");
        String msg = "===> TRANSLATION PERCENT " + makeBarBySignAndLength(barSign) +
                String.format(" %.2f%%", rate * 100) ;
        System.out.print(String.format("%s [%s] %s",
                Main.TAG, Main.SDF_LOG.format(new Date(System.currentTimeMillis())), msg));
    }
